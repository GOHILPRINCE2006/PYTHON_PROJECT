...
urlpatterns = [
    # ========== PUBLIC PAGES ==========
    path('', views.home, name='home'),  # This becomes http://127.0.0.1:8000/admin/ (wrong!)
    
    # Change your home page to be separate:
    # path('home/', views.home, name='home'),  # Now http://127.0.0.1:8000/admin/home/
