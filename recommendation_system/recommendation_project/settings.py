...
# Change karo environment variable se
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-your-secret-key-change-this-later')
...
SOCIALACCOUNT_ADAPTER = 'recommendox.adapter.CustomSocialAccountAdapter'
